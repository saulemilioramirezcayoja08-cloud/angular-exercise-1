...
import {PaginationMetadata} from '../../../../services/order/models/search/order-search-response.model';

@Component({
  selector: 'app-list-bottom-order',
  standalone: false,
  templateUrl: './list-bottom-order.html',
  styleUrl: './list-bottom-order.css'
})
export class ListBottomOrder {
