...
@Component({
  selector: 'app-list-top-purchase',
  standalone: false,
  templateUrl: './list-top-purchase.html',
  styleUrl: './list-top-purchase.css'
})
export class ListTopPurchase implements OnInit, OnDestroy {
